...
COPY --from=builder /workspace/configs/config-portal.yml.sample /usr/yunji/cloudiac/config-portal.yml
COPY --from=builder /workspace/configs/config-runner.yml.sample /usr/yunji/cloudiac/config-runner.yml

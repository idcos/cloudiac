...
type PolicyGroup struct {
	...
	Description Text   `json:"description" gorm:"type:text;comment:描述" example:"本组包含对于安全合规的检查策略"`
	Enabled     bool   `json:"enabled" gorm:"default:true;comment:是否启用" example:"true"`
	Source      string `json:"source" gorm:"comment:来源：VCS/Registry"` // type:enum('vcs','registry');
